...
def upgrade() -> None:
    ...
    op.alter_column("orders", "total_price", existing_type=sa.Numeric(10, 2), nullable=False, server_default=sa.text("0.00"))
    ...
    op.alter_column("orders", "currency", existing_type=sa.String(length=3), nullable=False, server_default=sa.text("'INR'"))
